    ...
    },
    {
        ...
        functionParameterToInput: function(catalogFunction, parameter, value) {
            ...
            var sw = Rectangle.southwest(value);
						var se = Rectangle.southeast(value);
						var nw = Rectangle.northwest(value);
						var ne = Rectangle.northeast(value);
            var coordinates = [ [ 
						    [sw.longitude, sw.latitude], [se.longitude, se.latitude], [ne.longitude, ne.latitude], [nw.longitude, nw.latitude], [sw.longitude, sw.latitude]    
						] ];
