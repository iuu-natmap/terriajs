...
var registerCatalogMembers = function() {
    ...
    createCatalogMemberFromType.register('async-result', createDeprecatedConstructor('async-result', ResultPendingCatalogItem));
    ...
    createCatalogItemFromUrl.register(matchesUrl(/\/wps/i), WebProcessingServiceCatalogGroup, true);
    ...
    createCatalogItemFromUrl.register(undefined, WebProcessingServiceCatalogGroup, true);
